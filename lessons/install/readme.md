...
Python 3. Trying to limit the incidental complexity here and go with the more modern version until I hit a specific reason to go with the obsolete version.
